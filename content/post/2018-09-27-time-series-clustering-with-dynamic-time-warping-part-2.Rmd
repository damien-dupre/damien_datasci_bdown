...
p1 <- ggplot() + 
  ...
  geom_text(data=ggdendro::label(dtw_data), aes(x, -300, label=label, hjust=0.5, color=cluster), size=3) +
...
p1 <- ggplot() + 
  geom_segment(data=ggdendro::segment(dtw_data), aes(x=x, y=y, xend=xend, yend=yend)) + 
  geom_text(data=ggdendro::label(dtw_data), aes(x, -10, label=label, hjust=0.5, color=cluster), size=3) +
  geom_rect(data=cluster_box, aes(xmin=X1-.3, xmax=X2+.3, ymin=0, ymax=cluster_threshold, color=cluster_box.cluster), fill=NA)+
  coord_flip() + 
  scale_y_continuous("Distance") + 
  guides(color=FALSE, fill = FALSE)+
...
p1 <- ggplot() + 
  geom_segment(data=ggdendro::segment(dtw_data), aes(x=x, y=y, xend=xend, yend=yend)) + 
  geom_text(data=ggdendro::label(dtw_data), aes(x, -1, label=label, hjust=0.5, color=cluster), size=3) +
  geom_rect(data=cluster_box, aes(xmin=X1-.3, xmax=X2+.3, ymin=0, ymax=cluster_threshold, color=cluster_box.cluster), fill=NA)+
  coord_flip() + 
  scale_y_continuous("Distance") + 
  guides(color=FALSE, fill = FALSE)+

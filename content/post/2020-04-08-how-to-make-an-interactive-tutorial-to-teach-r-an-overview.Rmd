...
-	The first that I found was initiated [here in a question about the interactivity of bookdown documents](https://gitmemory.com/issue/rstudio/bookdown/851/595159119). Someone came across the activity of [ThebeLab]( https://thebelab.readthedocs.io/en/latest/) which is providing interfaces to binder for python code (see examples [here]( https://jupyterbook.org/01/3/plotting_the_classics) and [here]( https://thebelab.readthedocs.io/en/latest/_static/activate_button.html). This question was answered by [Christophe Dervieux]( https://twitter.com/chrisderv) saying that binder was not supporting R at this time. Christophe definitely made some progress when he shared in this [tweet]( https://twitter.com/chrisderv/status/1235668163741839373) his [success in creating an interactive .Rmd]( https://rpubs.com/cderv/581740)
...
1.	The blogdown theme/ Rmd file need to include a code linking it to 1/the repository connected to the binder docker R environment and 2/ the package thebelab which is interacting between both.
